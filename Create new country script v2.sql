...
set @CountryName = 'Angola Exploration Restricted'
...
BEGIN
	...
	INSERT INTO dbo.Countries ([Name],[UserDefinedName_1],[UserDefinedName_2],[UserDefinedName_3],[Tickler_Notification_Enabled], [Tickler_Notification_Body])
		 VALUES(@CountryName,'User Defined 1','User Defined 2','User Defined 3', 0, 'Please see the attached notification report...')
